...
TextField.Field = component$<TextareaHTMLAttributes<HTMLTextAreaElement>>((props) => {
    ...
    return (
        <textarea
            ...
            class="min-h-[120px] py-2 pl-4 pr-3 h-full w-full outline-none text-cms-body-small sm:text-cms-body-medium text-neutral-700 placeholder:text-neutral-400 bg-neutral-custom-base border-[1.5px] border-neutral-200 rounded-[6px] flex items-center justify-between"
        />
    );
});
